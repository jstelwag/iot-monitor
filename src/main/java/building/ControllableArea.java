...
public enum ControllableArea {
    ...
    apartment_II(Room.apartment_II, new GroupAddress(1, 5, 1), new GroupAddress(1, 5, 6), "1/5/8", new GroupAddress(1, 7, 0), "1/5/3", 1),
    apartment_II_bedroom(Room.apartment_II, new GroupAddress(1, 5, 61), null, null, null, null, 1),
    apartment_III(Room.apartment_III, new GroupAddress(1, 5, 11), new GroupAddress(1, 5, 16), "1/5/18", new GroupAddress(1, 7, 4), "1/5/13", 1),
