...
public class Building {
    ...
    void makeZoneMap() {
        ...
        zones.add(new HeatZone(HeatZone.ValveGroup.koetshuis_trap_15, 8, false, ControllableArea.room_f, HeatZone.Position.wall, "small bedroom"));
        ...
        zones.add(new HeatZone(HeatZone.ValveGroup.koetshuis_trap_15, 10, true, ControllableArea.room_f, HeatZone.Position.wall, "master bedroom"));
        ...
        zones.add(new HeatZone(HeatZone.ValveGroup.koetshuis_trap_6, 0, true, ControllableArea.room_f, HeatZone.Position.floor, "small bedroom"));
        ...
        zones.add(new HeatZone(HeatZone.ValveGroup.kasteel_zolder, 0, true, ControllableArea.room_2_bathroom, HeatZone.Position.floor, "Floor at entrance"));
        zones.add(new HeatZone(HeatZone.ValveGroup.kasteel_zolder, 1, true, ControllableArea.room_2_bathroom, HeatZone.Position.floor)); //todo unclear / weak
        ...
        zones.add(new HeatZone(HeatZone.ValveGroup.kasteel_hal, 11, true, ControllableArea.room_2, HeatZone.Position.floor, "convector south 2"));
        ...
        zones.add(new HeatZone(HeatZone.ValveGroup.kasteel_hal, 13, true, ControllableArea.room_2, HeatZone.Position.floor, "convector west 2"));
    }
}
